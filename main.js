...
function right()
{
    if(car_x<=800){car_x=car_x+10 ;uploadbackground(); uploadrover(); uploadrover1();win2();win1();}
}
function up1()
{
...
function right1()
{
    if(car1_x<=800){car1_x=car1_x+10 ;uploadbackground(); uploadrover1(); uploadrover();win2();win1();}
}
function win2()
{
    if(car_x >= 680 )
